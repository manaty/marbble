    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            text.forEach(function(line) {
                ...
                // if ((line.indexOf("# ") == 0 || heading2 == "Pronunciation" || heading2 == "Etymology") && heading1 == wordLanguage) {
                ...
                if ((!isNaN(line.charAt(1)) && line.charAt(2) == ":") || (line.indexOf("# ") == 0 || line.indexOf("* ") == 0) && (heading1 == wordLanguage || wordLanguage != "English")) {
                    ...
                    try {
                        ...
                        // if (wordCharactersRegex.test(checkDefinition)) { //makes sure there is actually a definition
